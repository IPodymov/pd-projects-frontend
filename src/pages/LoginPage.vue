...
.auth-form { width: 100%; max-width: 420px; display: grid; gap: var(--space-3); border: 1px solid var(--border); border-radius: var(--radius); padding: var(--space-4); background: #fff; }
